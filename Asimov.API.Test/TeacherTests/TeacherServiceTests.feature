Feature: TeacherServiceTests
	...
	Background: 
		...
		And A Director is already registered
		  | FirstName | LastName   | Age | Email                     | Password    | Phone     |
		  | Ricardo   | De la Cruz | 42  | forman.cruz1212@gmail.com | Ss924@d#p_s | 918274009 |
...
Scenario: Register Teacher
	When A Post Request is sent to Teacher
	 ...
	 | 100   | Alexandra | Ortega   | 32  | alexita.12@gmail.com | pl012KsQ | 911029382 | 1          |
